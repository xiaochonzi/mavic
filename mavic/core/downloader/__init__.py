...
from mavic.core.downloader.handler import DownloadHandler
from mavic.core.downloader.middleware import DownloaderMiddlewareManager
from mavic.utils.datetypes import LocalCache
from mavic.utils.http import urlparse_cached
...
class Downloader(object):
    ...
    async def fetch(self, request, spider):
        ...
        response = await self.middleware.download(self._download, request, spider)
